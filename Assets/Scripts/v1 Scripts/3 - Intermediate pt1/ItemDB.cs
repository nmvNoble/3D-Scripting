...
public class ItemDB : MonoBehaviour
{
    ...
    [SerializeField]
    private Dictionary<int, Rune> runes;
    public Dictionary<int, Rune> Runes
    {
        get{return runes;}
        private set{runes = value;}
    }
    private Rune rKnowledge, rQuickness, rDestruction, rRange;
    ...
    void Start()
    {
        ...
        rDestruction = CreateRune("Destruction", 2, "Your spells Deal More Damage when a spell has this rune.", 2, .5f);
